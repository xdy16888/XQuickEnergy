            ...
            if ("SUCCESS".equals(memo)) {
                ...
                for (int i = 0; i < jaList.length(); i++) {
                    ...
                    if (joItem.has("taskStatus")
                        ...
                        if (isFull) {
                            Log.recordLog("领取道具🎖[" + toolType.nickName() + "]#已满，暂不领取");
                            continue;
                        }
                        ...
                        if ("SUCCESS".equals(memo)) {
                            Log.farm("领取道具[" + taskTitle + "-" + toolType.nickName() + "]#" + awardCount + "张");
                        } else {
                    ...
                    switch (TaskStatus.valueOf(jo.getString("taskStatus"))) {
                        ...
                        case FINISHED:
                            ...
                            if ("SUCCESS".equals(memo)) {
                                ...
                                Log.farm("领取奖励[" + taskTitle + "]#" + jo.getInt("haveAddFoodStock") + "g饲料");
                                if (unreceiveTaskAward > 0)
                                    unreceiveTaskAward--;
                            } else {
                                Log.recordLog(memo, s);
    ...
    private static void visitAnimal() {
        try {
            ...
            if ("SUCCESS".equals(jo.getString("memo"))) {
                ...
                jo = new JSONObject(AntFarmRpcCall.visitChickenFeed(farmId));
                if ("SUCCESS".equals(jo.getString("memo"))) {
